...
ایجاد گواهینامه جدید                                        </h3>
                                ...
                                <div class="portlet-body">
                                    <form method="post" role="form" action="certificate_add2.php" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="input-group-addon">
                                                    ...
                                                    <input name="name" type="text" class="form-control" placeholder="  مثلا : گواهینامه ایزو 9001 ">
                                                </div><!-- /.input-group -->
                                            </div><!-- /.form-group -->
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="certificates.php"><button type="button" class="btn btn-warning btn-round">
                                                بازگشت
