                ...
                <div class="col-lg-12">
                    <div class="portlet box border shadow">
                        <div class="portlet-heading">
                            ...
                            <button onclick="location.href='certificate_add1.php'" class="btn btn-success curve">ایجاد گواهینامه جدید</button>
                        </div><!-- /.portlet-heading -->
                        ...
                        if($num2==0){echo "شما تاکنون هیچ  گواهینامه ای نداشته اید. جهت ایجاد گواهینامه، گزینه گواهینامه جدید را انتخاب کنید. ";goto a;}
                        ...
                        <div class="portlet-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="data-table">
                                    ...
                                    <?php
                                    $sql4="select * from certificates order by id desc";
                                    ...
                                    $image="../uploads/certificates/".$name.".".$fileType;
                                        ...
                                        <tr>
                                            ...
                                            <td <?php echo $s; ?>><a href="certificate_edit1.php?id=<?php  echo $id; ?>"><span class="badge badge-warning">ویرایش</span></a></td>
                                            <td <?php echo $s; ?>><a href="certificate_delete.php?id=<?php  echo $id; ?>"><span class="badge badge-danger">حذف</span></a></td>
                                        <?php
                                    }
                                    ?>
